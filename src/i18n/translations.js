...
const CALENDAR_TRANSLATIONS = {
  ...
  ko: {
    ...
    sendPushReminderOn: "\ub9ac\ub9c8\uc778\ub354: \ucf1c\uc9d0",
    sendPushReminderOff: "\ub9ac\ub9c8\uc778\ub354 \ub9cc\ub4e4\uae30?",
    translationPending: "\ubc88\uc5ed \uc911...",
    translationUnavailable: "\uc9c0\uae08\uc740 \ubc88\uc5ed\uc744 \ubd88\ub7ec\uc62c \uc218 \uc5c6\uc2b5\ub2c8\ub2e4.",
    showOriginalText: "\uc6d0\ubb38 \ubcf4\uae30",
    hideOriginalText: "\uc6d0\ubb38 \uc228\uae30\uae30",
    originalText: "\uc6d0\ubb38",
    backfillTranslations: "\uae30\uc874 \uc77c\uc815 \ubc88\uc5ed",
    backfillTranslationsWorking: "\uae30\uc874 \uc77c\uc815 \ubc88\uc5ed \uc911...",
    backfillCompleteTitle: "\ubc88\uc5ed \uc644\ub8cc",
    backfillSuccessMessage: "\uae30\uc874 \uc77c\uc815 {count}\uac1c\ub97c \ubc88\uc5ed\ud588\uc2b5\ub2c8\ub2e4. \uc774\ubbf8 \uc644\ub8cc\ub41c {skipped}\uac1c\ub294 \uac74\ub108\ub6f0\uc5c8\uc2b5\ub2c8\ub2e4.",
    backfillNoChangesMessage: "\ubc88\uc5ed\uc774 \ud544\uc694\ud55c \uae30\uc874 \uc77c\uc815\uc774 \uc5c6\uc2b5\ub2c8\ub2e4."
  },
  es: {
    ...
    sendPushReminderOn: "Recordatorio: Activado",
    sendPushReminderOff: "\u00bfCrear recordatorio?",
    translationPending: "Traducci\u00f3n en progreso...",
    translationUnavailable: "La traducci\u00f3n no est\u00e1 disponible en este momento.",
    showOriginalText: "Mostrar texto original",
    hideOriginalText: "Ocultar texto original",
    originalText: "Texto original",
    backfillTranslations: "Traducir entradas existentes",
    backfillTranslationsWorking: "Traduciendo entradas existentes...",
    backfillCompleteTitle: "Traducción completada",
    backfillSuccessMessage: "Se tradujeron {count} entradas existentes. Se omitieron {skipped} que ya estaban listas.",
    backfillNoChangesMessage: "No hay entradas antiguas que necesiten traducción."
  },
  pt: {
    ...
    sendPushReminderOn: "Lembrete: Ativo",
    sendPushReminderOff: "Criar lembrete?",
    translationPending: "Tradu\u00e7\u00e3o em andamento...",
    translationUnavailable: "A tradu\u00e7\u00e3o n\u00e3o est\u00e1 dispon\u00edvel no momento.",
    showOriginalText: "Mostrar texto original",
    hideOriginalText: "Ocultar texto original",
    originalText: "Texto original",
    backfillTranslations: "Traduzir entradas existentes",
    backfillTranslationsWorking: "Traduzindo entradas existentes...",
    backfillCompleteTitle: "Tradução concluída",
    backfillSuccessMessage: "{count} entradas existentes foram traduzidas. {skipped} já prontas foram ignoradas.",
    backfillNoChangesMessage: "Não há entradas antigas que precisem de tradução."
  }
};
...
const RAW_TRANSLATIONS = {
  en: {
    ...
    "settings.notifications.calendar.title": "Calendar Reminders",
    "settings.notifications.calendar.enabled": "Receive push notifications when a leader creates a calendar reminder.",
    "settings.notifications.calendar.disabled": "Calendar push reminders are turned off for your account.",
    ...
    "settings.username.eyebrow": "Account",
    "settings.username.title": "Change Username",
    "settings.username.description": "Tap to expand and update your login username.",
    "settings.username.placeholder": "New username",
    "settings.username.hint": "3-30 characters. Letters, numbers, underscores, hyphens, and periods only.",
    "settings.username.button": "Update Username",
    "settings.username.errorEmpty": "Username cannot be empty.",
    "settings.username.errorMin": "Must be at least 3 characters.",
    "settings.username.errorMax": "Must be 30 characters or fewer.",
    "settings.username.errorFormat": "Only letters, numbers, _ . - allowed.",
    "settings.username.successTitle": "Username Updated",
    "settings.username.successMessage": "Your username has been changed to \"{username}\".",
    "settings.password.eyebrow": "Account",
    "settings.password.title": "Change Password",
    "settings.password.description": "Tap to expand and update your password.",
    "settings.password.currentPlaceholder": "Current password",
    "settings.password.newPlaceholder": "New password (min 6 characters)",
    "settings.password.confirmPlaceholder": "Confirm new password",
    "settings.password.button": "Update Password",
    "settings.password.errorCurrent": "Enter your current password.",
    "settings.password.errorMin": "New password must be at least 6 characters.",
    "settings.password.errorMismatch": "Passwords do not match.",
    "settings.password.successTitle": "Password Updated",
    "settings.password.successMessage": "Your password has been changed successfully.",
    ...
    "more.calculators.description": "Open a hub for your resource and progression calculators.",
    ...
    "calculators.hero.eyebrow": "Calculators",
    "calculators.hero.description": "A dedicated hub for multiple alliance calculators will live here.",
    "calculators.badge": "In Progress",
    "calculators.library.eyebrow": "Library",
    "calculators.library.title": "Planned Calculators",
    "calculators.library.description": "These calculator tools are queued to be ported into the app from your existing workbook set.",
    "calculators.cardBadge": "Coming Soon",
    "calculators.hq.readyBadge": "Live",
    "calculators.hq.hero.eyebrow": "HQ Calculator",
    "calculators.hq.hero.title": "HQ Requirements",
    "calculators.hq.hero.description": "Check the supporting buildings needed for any HQ target before you queue the upgrade.",
    "calculators.hq.input.eyebrow": "Target",
    "calculators.hq.input.title": "Select HQ level",
    "calculators.hq.input.description": "Enter a target HQ level from 1 to 35.",
    "calculators.hq.targetLevel": "Target HQ level: {level}",
    "calculators.hq.targetLevelPickerTitle": "Choose HQ level",
    "calculators.hq.targetLevelPickerDetail": "Scroll to the HQ level you want to check.",
    "calculators.hq.wheelColumnLabel": "HQ Level",
    "calculators.hq.decrease": "Lower Level",
    "calculators.hq.increase": "Raise Level",
    "calculators.hq.rangeHint": "HQ requirement data is available for levels 1 through 35.",
    "calculators.hq.summary.eyebrow": "Requirements",
    "calculators.hq.summary.title": "HQ {level} Requirements",
    "calculators.hq.requirementCount": "{count} required buildings",
    "calculators.hq.noRequirements": "This HQ level has no supporting building requirements.",
    "calculators.hq.requirementLine": "{building} must be at level {level}.",
    "calculators.hq.byBuilding.eyebrow": "Guide",
    "calculators.hq.byBuilding.title": "Requirement Milestones By Building",
    "calculators.hq.byBuilding.description": "Use this view to see when each building becomes a gate for future HQ progression.",
    "calculators.hq.milestone": "HQ {hqLevel} requires level {requiredLevel}",
    "calculators.hq.backToHub": "Back to Calculators",
    "calculators.cards.hqRequirements.title": "HQ Requirements",
    "calculators.cards.hqRequirements.description": "Track HQ upgrade requirements and supporting progression needs.",
    "calculators.cards.buildingResources.title": "Building Resources",
    "calculators.cards.buildingResources.description": "Estimate the resources needed for building upgrades.",
    "calculators.building.hero.eyebrow": "Building Calculator",
    "calculators.building.hero.title": "Building Resources",
    "calculators.building.hero.description": "Check the resource package needed for a specific HQ upgrade and its prerequisite buildings.",
    "calculators.building.input.eyebrow": "Inputs",
    "calculators.building.input.title": "Select HQ target and reduction",
    "calculators.building.input.description": "Choose the HQ upgrade you want to price out, then apply any resource reduction bonus.",
    "calculators.building.startLevel": "Starting HQ level: {level}",
    "calculators.building.targetLevel": "Target HQ level: {level}",
    "calculators.building.startLevelPickerTitle": "Choose starting HQ level",
    "calculators.building.startLevelPickerDetail": "Scroll to the HQ level you are starting from.",
    "calculators.building.targetLevelPickerTitle": "Choose HQ level",
    "calculators.building.targetLevelPickerDetail": "Scroll to the HQ upgrade package you want to review.",
    "calculators.building.wheelColumnLabel": "HQ Level",
    "calculators.building.reductionPlaceholder": "Resource reduction %",
    "calculators.building.reductionHint": "Current reduction applied: {value}%",
    "calculators.building.totals.eyebrow": "Totals",
    "calculators.building.totals.title": "HQ {start} to {target} Resource Totals",
    "calculators.building.totals.description": "These totals reflect the selected HQ level plus each prerequisite building upgrade for that one HQ jump.",
    "calculators.building.requirements.eyebrow": "Requirements",
    "calculators.building.requirements.title": "Required Building Upgrades",
    "calculators.building.requirements.description": "Each row represents one upgrade step included in the HQ package.",
    "calculators.building.additional.eyebrow": "Additional Buildings",
    "calculators.building.additional.title": "Optional Building Upgrades",
    "calculators.building.additional.description": "Add extra one-step building upgrades on top of the HQ path totals.",
    "calculators.building.additional.empty": "No extra building upgrades added yet.",
    "calculators.building.additional.addButton": "Add Additional Building",
    "calculators.building.additional.builderTitle": "Add Building Upgrade",
    "calculators.building.additional.builderDetail": "Choose a building and one upgrade step to add into the totals.",
    "calculators.building.additional.supportedLevelsHint": "Only workbook-supported upgrade levels are shown here.",
    "calculators.building.additional.buildingLabel": "Building",
    "calculators.building.additional.levelLabel": "Upgrade",
    "calculators.building.additional.confirmAdd": "Add Upgrade",
    "calculators.building.additionalBadge": "Additional",
    "calculators.building.removeAdditional": "Remove",
    "calculators.building.levelShift": "Level {from} -> {to}",
    "calculators.building.required": "Required",
    "calculators.building.oneOf": "One Of",
    "calculators.building.costUnavailable": "Resource data is not available for this row yet.",
    "calculators.building.resourceLine": "Gold {gold} | Iron {iron} | Food {food} | Oil {oil}",
    "calculators.building.reductionApplied": "Reduction applied: {value}%",
    "calculators.building.missingCostNote": "Some rows still need source cost data, so those totals are excluded until we add them.",
    "calculators.building.resources.gold": "Gold",
    "calculators.building.resources.iron": "Iron",
    "calculators.building.resources.food": "Food",
    "calculators.building.resources.oil": "Oil",
    "calculators.cards.buildResearchTime.title": "Build / Research Time",
    "calculators.cards.buildResearchTime.description": "Compare and estimate construction and research timers.",
    "calculators.cards.research.title": "Research",
    "calculators.cards.research.description": "Break down resource and progression needs for research goals.",
    "calculators.cards.allianceHelpTime.title": "Alliance Help Time",
    "calculators.cards.allianceHelpTime.description": "Estimate timer reductions from alliance help support.",
    "calculators.cards.gear.title": "Gear",
    "calculators.cards.gear.description": "Plan gear progression and supporting material requirements.",
    "calculators.cards.heroExp.title": "Hero EXP",
    "calculators.cards.heroExp.description": "Estimate hero experience requirements and progression targets.",
    "calculators.cards.heroShards.title": "Hero Shards",
    "calculators.cards.heroShards.description": "Track shard requirements for hero progression.",
    "calculators.cards.skillMedals.title": "Skill Medals",
    "calculators.cards.skillMedals.description": "Plan medal usage and upgrade requirements.",
    "calculators.cards.weaponShards.title": "Weapon Shards",
    "calculators.cards.weaponShards.description": "Estimate shard totals needed for weapon progression.",
    ...
    "leaderControls.reachability.issueBadge": "Issues",
    "leaderControls.reachability.allGoodBadge": "All Good",
    "leaderControls.reachability.badgeOptedOut": "Opted Out",
    "leaderControls.reachability.badgeNoToken": "No Token",
    ...
    "leaderControls.joinRequests.pendingCount": "{count} pending",
    "leaderControls.passwordReset.eyebrow": "Leader Controls",
    "leaderControls.passwordReset.title": "Member Password Reset",
    "leaderControls.passwordReset.description": "Tap to expand and generate a temporary password for a locked-out member.",
    "leaderControls.passwordReset.searchPlaceholder": "Search members...",
    "leaderControls.passwordReset.button": "Reset Password",
    "leaderControls.passwordReset.confirmTitle": "Reset password for {name}?",
    "leaderControls.passwordReset.confirmDescription": "They requested a new temporary password. This will generate one you can share with them.",
    "leaderControls.addMember.eyebrow": "Roster Management",
    "leaderControls.addMember.title": "Add Member",
    "leaderControls.addMember.description": "Tap to expand and add a new member to your alliance.",
    "leaderControls.addMember.namePlaceholder": "Member name",
    "leaderControls.addMember.powerHint": "Enter power in millions (e.g. 12,700,000 = 12.7)",
    "leaderControls.addMember.powerPlaceholder": "Power (M)",
    "leaderControls.addMember.button": "Add Member",
    "leaderControls.allianceCode.eyebrow": "Alliance Management",
    "leaderControls.allianceCode.title": "Alliance Code",
    "leaderControls.allianceCode.description": "Tap to expand and update your alliance join code.",
    "leaderControls.allianceCode.placeholder": "New alliance code",
    "leaderControls.allianceCode.button": "Update Code",
  ...
  ko: {
    ...
    "settings.notifications.calendar.title": "캘린더 리마인더",
    "settings.notifications.calendar.enabled": "리더가 캘린더 리마인더를 만들면 푸시 알림을 받습니다.",
    "settings.notifications.calendar.disabled": "캘린더 푸시 리마인더가 꺼져 있습니다.",
    ...
    "settings.username.eyebrow": "계정",
    "settings.username.title": "사용자 이름 변경",
    "settings.username.description": "탭하여 로그인 사용자 이름을 펼치고 업데이트하세요.",
    "settings.username.placeholder": "새 사용자 이름",
    "settings.username.hint": "3~30자. 문자, 숫자, 밑줄, 하이픈, 마침표만 사용할 수 있습니다.",
    "settings.username.button": "사용자 이름 업데이트",
    "settings.username.errorEmpty": "사용자 이름은 비워 둘 수 없습니다.",
    "settings.username.errorMin": "최소 3자 이상이어야 합니다.",
    "settings.username.errorMax": "30자를 초과할 수 없습니다.",
    "settings.username.errorFormat": "문자, 숫자, _ . - 만 사용할 수 있습니다.",
    "settings.username.successTitle": "사용자 이름이 업데이트되었습니다",
    "settings.username.successMessage": "사용자 이름이 \"{username}\"(으)로 변경되었습니다.",
    "settings.password.eyebrow": "계정",
    "settings.password.title": "비밀번호 변경",
    "settings.password.description": "탭하여 비밀번호를 펼치고 업데이트하세요.",
    "settings.password.currentPlaceholder": "현재 비밀번호",
    "settings.password.newPlaceholder": "새 비밀번호 (최소 6자)",
    "settings.password.confirmPlaceholder": "새 비밀번호 확인",
    "settings.password.button": "비밀번호 업데이트",
    "settings.password.errorCurrent": "현재 비밀번호를 입력하세요.",
    "settings.password.errorMin": "새 비밀번호는 최소 6자 이상이어야 합니다.",
    "settings.password.errorMismatch": "비밀번호가 일치하지 않습니다.",
    "settings.password.successTitle": "비밀번호가 업데이트되었습니다",
    "settings.password.successMessage": "비밀번호가 성공적으로 변경되었습니다.",
    ...
    "more.calculators.description": "자원 및 성장 계산기 허브를 엽니다.",
    ...
    "calculators.title": "계산기",
    "calculators.hero.eyebrow": "계산기",
    "calculators.hero.description": "여러 얼라이언스 계산기를 위한 전용 허브가 여기에 들어옵니다.",
    "calculators.badge": "준비 중",
    "calculators.library.eyebrow": "라이브러리",
    "calculators.library.title": "예정된 계산기",
    "calculators.library.description": "기존 워크북 세트의 계산기들이 이 앱으로 순차적으로 옮겨질 예정입니다.",
    "calculators.cardBadge": "곧 제공",
    "calculators.hq.readyBadge": "사용 가능",
    "calculators.hq.hero.eyebrow": "HQ 계산기",
    "calculators.hq.hero.title": "HQ 요구사항",
    "calculators.hq.hero.description": "업그레이드를 시작하기 전에 목표 HQ에 필요한 지원 건물을 빠르게 확인하세요.",
    "calculators.hq.input.eyebrow": "목표",
    "calculators.hq.input.title": "HQ 레벨 선택",
    "calculators.hq.input.description": "1부터 35까지의 목표 HQ 레벨을 선택하세요.",
    "calculators.hq.targetLevel": "목표 HQ 레벨: {level}",
    "calculators.hq.targetLevelPickerTitle": "HQ 레벨 선택",
    "calculators.hq.targetLevelPickerDetail": "확인할 HQ 레벨까지 스크롤하세요.",
    "calculators.hq.wheelColumnLabel": "HQ 레벨",
    "calculators.hq.decrease": "레벨 낮추기",
    "calculators.hq.increase": "레벨 올리기",
    "calculators.hq.rangeHint": "HQ 요구 데이터는 1레벨부터 35레벨까지 제공됩니다.",
    "calculators.hq.summary.eyebrow": "요구사항",
    "calculators.hq.summary.title": "HQ {level} 요구사항",
    "calculators.hq.requirementCount": "필수 건물 {count}개",
    "calculators.hq.noRequirements": "이 HQ 레벨에는 추가 건물 요구사항이 없습니다.",
    "calculators.hq.requirementLine": "{building} 건물이 레벨 {level}이어야 합니다.",
    "calculators.hq.byBuilding.eyebrow": "가이드",
    "calculators.hq.byBuilding.title": "건물별 요구 마일스톤",
    "calculators.hq.byBuilding.description": "각 건물이 언제 다음 HQ 진행의 관문이 되는지 한눈에 확인할 수 있습니다.",
    "calculators.hq.milestone": "HQ {hqLevel}에서 레벨 {requiredLevel} 필요",
    "calculators.hq.backToHub": "계산기 허브로 돌아가기",
    "calculators.cards.hqRequirements.title": "HQ 요구사항",
    "calculators.cards.hqRequirements.description": "HQ 업그레이드 요구사항과 연계 성장 조건을 추적합니다.",
    "calculators.cards.buildingResources.title": "건물 자원",
    "calculators.cards.buildingResources.description": "건물 업그레이드에 필요한 자원을 추정합니다.",
    "calculators.building.hero.eyebrow": "건물 계산기",
    "calculators.building.hero.title": "건물 자원",
    "calculators.building.hero.description": "특정 HQ 업그레이드와 필요한 선행 건물에 드는 자원 묶음을 확인합니다.",
    "calculators.building.input.eyebrow": "입력",
    "calculators.building.input.title": "HQ 목표와 감소율 선택",
    "calculators.building.input.description": "계산할 HQ 업그레이드를 고르고 적용할 자원 감소 보너스를 입력하세요.",
    "calculators.building.startLevel": "시작 HQ 레벨: {level}",
    "calculators.building.targetLevel": "목표 HQ 레벨: {level}",
    "calculators.building.startLevelPickerTitle": "시작 HQ 레벨 선택",
    "calculators.building.startLevelPickerDetail": "현재 시작 지점인 HQ 레벨까지 스크롤하세요.",
    "calculators.building.targetLevelPickerTitle": "HQ 레벨 선택",
    "calculators.building.targetLevelPickerDetail": "검토할 HQ 업그레이드 패키지까지 스크롤하세요.",
    "calculators.building.wheelColumnLabel": "HQ 레벨",
    "calculators.building.reductionPlaceholder": "자원 감소 %",
    "calculators.building.reductionHint": "현재 적용 감소율: {value}%",
    "calculators.building.totals.eyebrow": "총합",
    "calculators.building.totals.title": "HQ {start}에서 {target}까지 자원 총합",
    "calculators.building.totals.description": "선택한 HQ 한 단계 업그레이드와 필요한 선행 건물 업그레이드를 모두 반영한 총합입니다.",
    "calculators.building.requirements.eyebrow": "요구사항",
    "calculators.building.requirements.title": "필수 건물 업그레이드",
    "calculators.building.requirements.description": "각 행은 HQ 패키지에 포함된 단일 업그레이드 단계를 나타냅니다.",
    "calculators.building.additional.eyebrow": "추가 건물",
    "calculators.building.additional.title": "선택 추가 업그레이드",
    "calculators.building.additional.description": "HQ 경로 총합 위에 추가할 단일 건물 업그레이드를 더하세요.",
    "calculators.building.additional.empty": "아직 추가된 건물 업그레이드가 없습니다.",
    "calculators.building.additional.addButton": "추가 건물 넣기",
    "calculators.building.additional.builderTitle": "건물 업그레이드 추가",
    "calculators.building.additional.builderDetail": "건물과 한 단계 업그레이드를 선택해 총합에 포함하세요.",
    "calculators.building.additional.supportedLevelsHint": "여기에는 워크북에서 지원하는 업그레이드 레벨만 표시됩니다.",
    "calculators.building.additional.buildingLabel": "건물",
    "calculators.building.additional.levelLabel": "업그레이드",
    "calculators.building.additional.confirmAdd": "업그레이드 추가",
    "calculators.building.additionalBadge": "추가",
    "calculators.building.removeAdditional": "제거",
    "calculators.building.levelShift": "레벨 {from} -> {to}",
    "calculators.building.required": "필수",
    "calculators.building.oneOf": "택1",
    "calculators.building.costUnavailable": "이 행의 자원 데이터는 아직 준비되지 않았습니다.",
    "calculators.building.resourceLine": "골드 {gold} | 철 {iron} | 식량 {food} | 오일 {oil}",
    "calculators.building.reductionApplied": "적용 감소율: {value}%",
    "calculators.building.missingCostNote": "일부 행은 아직 원본 비용 데이터가 없어 총합에서 제외됩니다.",
    "calculators.building.resources.gold": "골드",
    "calculators.building.resources.iron": "철",
    "calculators.building.resources.food": "식량",
    "calculators.building.resources.oil": "오일",
    "calculators.cards.buildResearchTime.title": "건설 / 연구 시간",
    "calculators.cards.buildResearchTime.description": "건설 및 연구 시간을 비교하고 추정합니다.",
    "calculators.cards.research.title": "연구",
    "calculators.cards.research.description": "연구 목표에 필요한 자원과 성장 조건을 정리합니다.",
    "calculators.cards.allianceHelpTime.title": "얼라이언스 도움 시간",
    "calculators.cards.allianceHelpTime.description": "얼라이언스 도움으로 줄어드는 시간을 추정합니다.",
    "calculators.cards.gear.title": "장비",
    "calculators.cards.gear.description": "장비 성장과 필요한 재료를 계획합니다.",
    "calculators.cards.heroExp.title": "영웅 EXP",
    "calculators.cards.heroExp.description": "영웅 경험치 요구량과 성장 목표를 추정합니다.",
    "calculators.cards.heroShards.title": "영웅 조각",
    "calculators.cards.heroShards.description": "영웅 성장에 필요한 조각 수량을 추적합니다.",
    "calculators.cards.skillMedals.title": "스킬 메달",
    "calculators.cards.skillMedals.description": "메달 사용량과 업그레이드 요구량을 계획합니다.",
    "calculators.cards.weaponShards.title": "무기 조각",
    "calculators.cards.weaponShards.description": "무기 성장에 필요한 조각 수량을 추정합니다.",
    "common.member": "멤버",
    "common.delete": "삭제",
    "home.title": "홈",
    ...
    "leaderControls.reachability.issueBadge": "문제 있음",
    "leaderControls.reachability.allGoodBadge": "정상",
    "leaderControls.reachability.badgeOptedOut": "수신 거부",
    "leaderControls.reachability.badgeNoToken": "토큰 없음",
    ...
    "leaderControls.joinRequests.pendingCount": "{count}건 대기 중",
    "leaderControls.passwordReset.eyebrow": "리더 제어",
    "leaderControls.passwordReset.title": "멤버 비밀번호 재설정",
    "leaderControls.passwordReset.description": "탭하여 잠긴 멤버용 임시 비밀번호를 생성하세요.",
    "leaderControls.passwordReset.searchPlaceholder": "멤버 검색...",
    "leaderControls.passwordReset.button": "비밀번호 재설정",
    "leaderControls.passwordReset.confirmTitle": "{name} 님의 비밀번호를 재설정할까요?",
    "leaderControls.passwordReset.confirmDescription": "이 멤버는 새 임시 비밀번호를 요청했습니다. 공유할 수 있는 새 비밀번호가 생성됩니다.",
    "leaderControls.addMember.eyebrow": "로스터 관리",
    "leaderControls.addMember.title": "멤버 추가",
    "leaderControls.addMember.description": "탭하여 얼라이언스에 새 멤버를 추가하세요.",
    "leaderControls.addMember.namePlaceholder": "멤버 이름",
    "leaderControls.addMember.powerHint": "전투력은 백만 단위로 입력하세요. 예: 12,700,000 = 12.7",
    "leaderControls.addMember.powerPlaceholder": "전투력 (M)",
    "leaderControls.addMember.button": "멤버 추가",
    "leaderControls.allianceCode.eyebrow": "얼라이언스 관리",
    "leaderControls.allianceCode.title": "얼라이언스 코드",
    "leaderControls.allianceCode.description": "탭하여 얼라이언스 가입 코드를 업데이트하세요.",
    "leaderControls.allianceCode.placeholder": "새 얼라이언스 코드",
    "leaderControls.allianceCode.button": "코드 업데이트",
  ...
  es: {
    ...
    "settings.notifications.calendar.title": "Recordatorios del calendario",
    "settings.notifications.calendar.enabled": "Recibe notificaciones push cuando un líder crea un recordatorio del calendario.",
    "settings.notifications.calendar.disabled": "Los recordatorios push del calendario están desactivados para tu cuenta.",
    ...
    "settings.username.eyebrow": "Cuenta",
    "settings.username.title": "Cambiar nombre de usuario",
    "settings.username.description": "Toca para desplegar y actualizar tu nombre de usuario de acceso.",
    "settings.username.placeholder": "Nuevo nombre de usuario",
    "settings.username.hint": "De 3 a 30 caracteres. Solo letras, números, guiones bajos, guiones y puntos.",
    "settings.username.button": "Actualizar nombre de usuario",
    "settings.username.errorEmpty": "El nombre de usuario no puede estar vacío.",
    "settings.username.errorMin": "Debe tener al menos 3 caracteres.",
    "settings.username.errorMax": "Debe tener 30 caracteres o menos.",
    "settings.username.errorFormat": "Solo se permiten letras, números, _ . - .",
    "settings.username.successTitle": "Nombre de usuario actualizado",
    "settings.username.successMessage": "Tu nombre de usuario se cambió a \"{username}\".",
    "settings.password.eyebrow": "Cuenta",
    "settings.password.title": "Cambiar contraseña",
    "settings.password.description": "Toca para desplegar y actualizar tu contraseña.",
    "settings.password.currentPlaceholder": "Contraseña actual",
    "settings.password.newPlaceholder": "Nueva contraseña (mínimo 6 caracteres)",
    "settings.password.confirmPlaceholder": "Confirmar nueva contraseña",
    "settings.password.button": "Actualizar contraseña",
    "settings.password.errorCurrent": "Introduce tu contraseña actual.",
    "settings.password.errorMin": "La nueva contraseña debe tener al menos 6 caracteres.",
    "settings.password.errorMismatch": "Las contraseñas no coinciden.",
    "settings.password.successTitle": "Contraseña actualizada",
    "settings.password.successMessage": "Tu contraseña se cambió correctamente.",
    ...
    "more.calculators.description": "Abre un centro para tus calculadoras de recursos y progreso.",
    ...
    "calculators.hero.eyebrow": "Calculadoras",
    "calculators.hero.description": "Aquí vivirá un centro dedicado para múltiples calculadoras de la alianza.",
    "calculators.badge": "En progreso",
    "calculators.library.eyebrow": "Biblioteca",
    "calculators.library.title": "Calculadoras previstas",
    "calculators.library.description": "Estas herramientas se migrarán a la app desde tu conjunto actual de hojas de cálculo.",
    "calculators.cardBadge": "Próximamente",
    "calculators.hq.readyBadge": "Disponible",
    "calculators.hq.hero.eyebrow": "Calculadora HQ",
    "calculators.hq.hero.title": "Requisitos de HQ",
    "calculators.hq.hero.description": "Revisa los edificios de apoyo necesarios para cualquier objetivo de HQ antes de iniciar la mejora.",
    "calculators.hq.input.eyebrow": "Objetivo",
    "calculators.hq.input.title": "Selecciona el nivel de HQ",
    "calculators.hq.input.description": "Ingresa un nivel de HQ entre 1 y 35.",
    "calculators.hq.targetLevel": "Nivel objetivo de HQ: {level}",
    "calculators.hq.targetLevelPickerTitle": "Elegir nivel de HQ",
    "calculators.hq.targetLevelPickerDetail": "Desplázate hasta el nivel de HQ que quieres revisar.",
    "calculators.hq.wheelColumnLabel": "Nivel de HQ",
    "calculators.hq.decrease": "Bajar nivel",
    "calculators.hq.increase": "Subir nivel",
    "calculators.hq.rangeHint": "Los datos de requisitos de HQ están disponibles para los niveles 1 al 35.",
    "calculators.hq.summary.eyebrow": "Requisitos",
    "calculators.hq.summary.title": "Requisitos de HQ {level}",
    "calculators.hq.requirementCount": "{count} edificios requeridos",
    "calculators.hq.noRequirements": "Este nivel de HQ no tiene requisitos adicionales de edificios.",
    "calculators.hq.requirementLine": "{building} debe estar en nivel {level}.",
    "calculators.hq.byBuilding.eyebrow": "Guía",
    "calculators.hq.byBuilding.title": "Hitos de requisitos por edificio",
    "calculators.hq.byBuilding.description": "Úsalo para ver cuándo cada edificio se convierte en un bloqueo para seguir avanzando el HQ.",
    "calculators.hq.milestone": "HQ {hqLevel} requiere nivel {requiredLevel}",
    "calculators.hq.backToHub": "Volver a Calculadoras",
    "calculators.cards.hqRequirements.title": "Requisitos de HQ",
    "calculators.cards.hqRequirements.description": "Sigue los requisitos de mejora del HQ y las necesidades de progreso asociadas.",
    "calculators.cards.buildingResources.title": "Recursos de construcción",
    "calculators.cards.buildingResources.description": "Calcula los recursos necesarios para mejorar edificios.",
    "calculators.building.hero.eyebrow": "Calculadora de edificios",
    "calculators.building.hero.title": "Recursos de construcción",
    "calculators.building.hero.description": "Consulta el paquete de recursos necesario para una mejora concreta de HQ y sus edificios previos.",
    "calculators.building.input.eyebrow": "Entradas",
    "calculators.building.input.title": "Selecciona HQ objetivo y reducción",
    "calculators.building.input.description": "Elige la mejora de HQ que quieres calcular y aplica cualquier bonificación de reducción de recursos.",
    "calculators.building.startLevel": "Nivel inicial de HQ: {level}",
    "calculators.building.targetLevel": "Nivel objetivo de HQ: {level}",
    "calculators.building.startLevelPickerTitle": "Elegir nivel inicial de HQ",
    "calculators.building.startLevelPickerDetail": "Desplázate hasta el nivel de HQ desde el que comienzas.",
    "calculators.building.targetLevelPickerTitle": "Elegir nivel de HQ",
    "calculators.building.targetLevelPickerDetail": "Desplázate hasta el paquete de mejora de HQ que quieres revisar.",
    "calculators.building.wheelColumnLabel": "Nivel de HQ",
    "calculators.building.reductionPlaceholder": "Reducción de recursos %",
    "calculators.building.reductionHint": "Reducción actual aplicada: {value}%",
    "calculators.building.totals.eyebrow": "Totales",
    "calculators.building.totals.title": "Totales de recursos de HQ {start} a {target}",
    "calculators.building.totals.description": "Estos totales reflejan ese salto de HQ y cada mejora previa requerida para completar ese paso.",
    "calculators.building.requirements.eyebrow": "Requisitos",
    "calculators.building.requirements.title": "Mejoras de edificios requeridas",
    "calculators.building.requirements.description": "Cada fila representa un paso de mejora incluido en el paquete de HQ.",
    "calculators.building.additional.eyebrow": "Edificios adicionales",
    "calculators.building.additional.title": "Mejoras opcionales",
    "calculators.building.additional.description": "Añade mejoras extra de un solo paso encima de los totales del camino de HQ.",
    "calculators.building.additional.empty": "Todavía no se han añadido mejoras extra.",
    "calculators.building.additional.addButton": "Añadir edificio adicional",
    "calculators.building.additional.builderTitle": "Añadir mejora de edificio",
    "calculators.building.additional.builderDetail": "Elige un edificio y un solo paso de mejora para sumarlo a los totales.",
    "calculators.building.additional.supportedLevelsHint": "Aquí solo se muestran los niveles de mejora compatibles con el libro.",
    "calculators.building.additional.buildingLabel": "Edificio",
    "calculators.building.additional.levelLabel": "Mejora",
    "calculators.building.additional.confirmAdd": "Añadir mejora",
    "calculators.building.additionalBadge": "Adicional",
    "calculators.building.removeAdditional": "Quitar",
    "calculators.building.levelShift": "Nivel {from} -> {to}",
    "calculators.building.required": "Requerido",
    "calculators.building.oneOf": "Uno de",
    "calculators.building.costUnavailable": "Todavía no hay datos de recursos para esta fila.",
    "calculators.building.resourceLine": "Oro {gold} | Hierro {iron} | Comida {food} | Petróleo {oil}",
    "calculators.building.reductionApplied": "Reducción aplicada: {value}%",
    "calculators.building.missingCostNote": "Algunas filas todavía no tienen datos de coste de origen, así que se excluyen de los totales.",
    "calculators.building.resources.gold": "Oro",
    "calculators.building.resources.iron": "Hierro",
    "calculators.building.resources.food": "Comida",
    "calculators.building.resources.oil": "Petróleo",
    "calculators.cards.buildResearchTime.title": "Tiempo de construcción / investigación",
    "calculators.cards.buildResearchTime.description": "Compara y estima temporizadores de construcción e investigación.",
    "calculators.cards.research.title": "Investigación",
    "calculators.cards.research.description": "Desglosa recursos y progreso necesarios para objetivos de investigación.",
    "calculators.cards.allianceHelpTime.title": "Tiempo de ayuda de alianza",
    "calculators.cards.allianceHelpTime.description": "Estima las reducciones de tiempo por ayuda de la alianza.",
    "calculators.cards.gear.title": "Equipo",
    "calculators.cards.gear.description": "Planifica el progreso de equipo y los materiales necesarios.",
    "calculators.cards.heroExp.title": "EXP de héroe",
    "calculators.cards.heroExp.description": "Estima la experiencia necesaria para progresar con héroes.",
    "calculators.cards.heroShards.title": "Fragmentos de héroe",
    "calculators.cards.heroShards.description": "Sigue los fragmentos necesarios para el progreso de héroes.",
    "calculators.cards.skillMedals.title": "Medallas de habilidad",
    "calculators.cards.skillMedals.description": "Planifica el uso de medallas y los requisitos de mejora.",
    "calculators.cards.weaponShards.title": "Fragmentos de arma",
    "calculators.cards.weaponShards.description": "Estima los fragmentos necesarios para progresión de armas.",
    ...
    "leaderControls.reachability.issueBadge": "Problemas",
    "leaderControls.reachability.allGoodBadge": "Todo bien",
    "leaderControls.reachability.badgeOptedOut": "Excluido",
    "leaderControls.reachability.badgeNoToken": "Sin token",
    ...
    "leaderControls.joinRequests.pendingCount": "{count} pendientes",
    "leaderControls.passwordReset.eyebrow": "Controles de líder",
    "leaderControls.passwordReset.title": "Restablecer contraseña de miembro",
    "leaderControls.passwordReset.description": "Toca para desplegar y generar una contraseña temporal para un miembro bloqueado.",
    "leaderControls.passwordReset.searchPlaceholder": "Buscar miembros...",
    "leaderControls.passwordReset.button": "Restablecer contraseña",
    "leaderControls.passwordReset.confirmTitle": "¿Restablecer la contraseña de {name}?",
    "leaderControls.passwordReset.confirmDescription": "Solicitó una nueva contraseña temporal. Esto generará una que puedes compartirle.",
    "leaderControls.addMember.eyebrow": "Gestión del roster",
    "leaderControls.addMember.title": "Agregar miembro",
    "leaderControls.addMember.description": "Toca para desplegar y agregar un nuevo miembro a tu alianza.",
    "leaderControls.addMember.namePlaceholder": "Nombre del miembro",
    "leaderControls.addMember.powerHint": "Introduce el poder en millones (por ejemplo, 12,700,000 = 12.7)",
    "leaderControls.addMember.powerPlaceholder": "Poder (M)",
    "leaderControls.addMember.button": "Agregar miembro",
    "leaderControls.allianceCode.eyebrow": "Gestión de la alianza",
    "leaderControls.allianceCode.title": "Código de alianza",
    "leaderControls.allianceCode.description": "Toca para desplegar y actualizar el código de ingreso de tu alianza.",
    "leaderControls.allianceCode.placeholder": "Nuevo código de alianza",
    "leaderControls.allianceCode.button": "Actualizar código",
  ...
  pt: {
    ...
    "settings.username.eyebrow": "Conta",
    "settings.username.title": "Alterar nome de usuário",
    "settings.username.description": "Toque para expandir e atualizar seu nome de usuário de login.",
    "settings.username.placeholder": "Novo nome de usuário",
    "settings.username.hint": "De 3 a 30 caracteres. Apenas letras, números, sublinhados, hífens e pontos.",
    "settings.username.button": "Atualizar nome de usuário",
    "settings.username.errorEmpty": "O nome de usuário não pode ficar vazio.",
    "settings.username.errorMin": "Deve ter pelo menos 3 caracteres.",
    "settings.username.errorMax": "Deve ter no máximo 30 caracteres.",
    "settings.username.errorFormat": "Somente letras, números, _ . - são permitidos.",
    "settings.username.successTitle": "Nome de usuário atualizado",
    "settings.username.successMessage": "Seu nome de usuário foi alterado para \"{username}\".",
    "settings.password.eyebrow": "Conta",
    "settings.password.title": "Alterar senha",
    "settings.password.description": "Toque para expandir e atualizar sua senha.",
    "settings.password.currentPlaceholder": "Senha atual",
    "settings.password.newPlaceholder": "Nova senha (mínimo de 6 caracteres)",
    "settings.password.confirmPlaceholder": "Confirmar nova senha",
    "settings.password.button": "Atualizar senha",
    "settings.password.errorCurrent": "Digite sua senha atual.",
    "settings.password.errorMin": "A nova senha deve ter pelo menos 6 caracteres.",
    "settings.password.errorMismatch": "As senhas não coincidem.",
    "settings.password.successTitle": "Senha atualizada",
    "settings.password.successMessage": "Sua senha foi alterada com sucesso.",
    ...
    "more.calculators.description": "Abra um hub para suas calculadoras de recursos e progressão.",
    "more.leaderControls.title": "Controles de líder",
    ...
    "calculators.title": "Calculadoras",
    "calculators.hero.eyebrow": "Calculadoras",
    "calculators.hero.description": "Um hub dedicado para várias calculadoras da aliança ficará aqui.",
    "calculators.badge": "Em andamento",
    "calculators.library.eyebrow": "Biblioteca",
    "calculators.library.title": "Calculadoras planejadas",
    "calculators.library.description": "Essas ferramentas serão trazidas para o app a partir do seu conjunto atual de planilhas.",
    "calculators.cardBadge": "Em breve",
    "calculators.hq.readyBadge": "Disponível",
    "calculators.hq.hero.eyebrow": "Calculadora de HQ",
    "calculators.hq.hero.title": "Requisitos de HQ",
    "calculators.hq.hero.description": "Confira os prédios de apoio necessários para qualquer meta de HQ antes de iniciar o upgrade.",
    "calculators.hq.input.eyebrow": "Meta",
    "calculators.hq.input.title": "Selecione o nível de HQ",
    "calculators.hq.input.description": "Informe um nível de HQ entre 1 e 35.",
    "calculators.hq.targetLevel": "Nível alvo de HQ: {level}",
    "calculators.hq.targetLevelPickerTitle": "Escolher nível de HQ",
    "calculators.hq.targetLevelPickerDetail": "Role até o nível de HQ que você quer verificar.",
    "calculators.hq.wheelColumnLabel": "Nível de HQ",
    "calculators.hq.decrease": "Reduzir nível",
    "calculators.hq.increase": "Aumentar nível",
    "calculators.hq.rangeHint": "Os dados de requisitos de HQ estão disponíveis do nível 1 ao 35.",
    "calculators.hq.summary.eyebrow": "Requisitos",
    "calculators.hq.summary.title": "Requisitos de HQ {level}",
    "calculators.hq.requirementCount": "{count} prédios necessários",
    "calculators.hq.noRequirements": "Este nível de HQ não possui requisitos adicionais de prédios.",
    "calculators.hq.requirementLine": "{building} precisa estar no nível {level}.",
    "calculators.hq.byBuilding.eyebrow": "Guia",
    "calculators.hq.byBuilding.title": "Marcos de requisito por prédio",
    "calculators.hq.byBuilding.description": "Use esta visão para saber quando cada prédio passa a bloquear a progressão do HQ.",
    "calculators.hq.milestone": "HQ {hqLevel} exige nível {requiredLevel}",
    "calculators.hq.backToHub": "Voltar para Calculadoras",
    "calculators.cards.hqRequirements.title": "Requisitos de HQ",
    "calculators.cards.hqRequirements.description": "Acompanhe requisitos de upgrade do HQ e necessidades de progressão associadas.",
    "calculators.cards.buildingResources.title": "Recursos de construção",
    "calculators.cards.buildingResources.description": "Estime os recursos necessários para upgrades de construção.",
    "calculators.building.hero.eyebrow": "Calculadora de prédios",
    "calculators.building.hero.title": "Recursos de construção",
    "calculators.building.hero.description": "Confira o pacote de recursos necessário para um upgrade específico de HQ e seus prédios pré-requisitos.",
    "calculators.building.input.eyebrow": "Entradas",
    "calculators.building.input.title": "Selecione HQ alvo e redução",
    "calculators.building.input.description": "Escolha o upgrade de HQ que você quer calcular e aplique qualquer bônus de redução de recursos.",
    "calculators.building.startLevel": "Nível inicial de HQ: {level}",
    "calculators.building.targetLevel": "Nível alvo de HQ: {level}",
    "calculators.building.startLevelPickerTitle": "Escolher nível inicial de HQ",
    "calculators.building.startLevelPickerDetail": "Role até o nível de HQ de onde você está começando.",
    "calculators.building.targetLevelPickerTitle": "Escolher nível de HQ",
    "calculators.building.targetLevelPickerDetail": "Role até o pacote de upgrade de HQ que você quer revisar.",
    "calculators.building.wheelColumnLabel": "Nível de HQ",
    "calculators.building.reductionPlaceholder": "Redução de recursos %",
    "calculators.building.reductionHint": "Redução atual aplicada: {value}%",
    "calculators.building.totals.eyebrow": "Totais",
    "calculators.building.totals.title": "Totais de recursos do HQ {start} ao {target}",
    "calculators.building.totals.description": "Esses totais refletem esse salto de HQ e cada upgrade pré-requisito necessário para concluir essa etapa.",
    "calculators.building.requirements.eyebrow": "Requisitos",
    "calculators.building.requirements.title": "Upgrades de prédios necessários",
    "calculators.building.requirements.description": "Cada linha representa uma etapa de upgrade incluída no pacote de HQ.",
    "calculators.building.additional.eyebrow": "Prédios adicionais",
    "calculators.building.additional.title": "Upgrades opcionais",
    "calculators.building.additional.description": "Adicione upgrades extras de uma etapa por cima dos totais do caminho de HQ.",
    "calculators.building.additional.empty": "Nenhum upgrade extra foi adicionado ainda.",
    "calculators.building.additional.addButton": "Adicionar prédio extra",
    "calculators.building.additional.builderTitle": "Adicionar upgrade de prédio",
    "calculators.building.additional.builderDetail": "Escolha um prédio e uma etapa de upgrade para somar aos totais.",
    "calculators.building.additional.supportedLevelsHint": "Aqui só aparecem níveis de upgrade suportados pela planilha.",
    "calculators.building.additional.buildingLabel": "Prédio",
    "calculators.building.additional.levelLabel": "Upgrade",
    "calculators.building.additional.confirmAdd": "Adicionar upgrade",
    "calculators.building.additionalBadge": "Adicional",
    "calculators.building.removeAdditional": "Remover",
    "calculators.building.levelShift": "Nível {from} -> {to}",
    "calculators.building.required": "Necessário",
    "calculators.building.oneOf": "Um deles",
    "calculators.building.costUnavailable": "Os dados de recursos desta linha ainda não estão disponíveis.",
    "calculators.building.resourceLine": "Ouro {gold} | Ferro {iron} | Comida {food} | Óleo {oil}",
    "calculators.building.reductionApplied": "Redução aplicada: {value}%",
    "calculators.building.missingCostNote": "Algumas linhas ainda precisam de dados de custo de origem, então ficam fora dos totais por enquanto.",
    "calculators.building.resources.gold": "Ouro",
    "calculators.building.resources.iron": "Ferro",
    "calculators.building.resources.food": "Comida",
    "calculators.building.resources.oil": "Óleo",
    "calculators.cards.buildResearchTime.title": "Tempo de construção / pesquisa",
    "calculators.cards.buildResearchTime.description": "Compare e estime tempos de construção e pesquisa.",
    "calculators.cards.research.title": "Pesquisa",
    "calculators.cards.research.description": "Organize recursos e progressão necessários para metas de pesquisa.",
    "calculators.cards.allianceHelpTime.title": "Tempo de ajuda da aliança",
    "calculators.cards.allianceHelpTime.description": "Estime reduções de tempo vindas da ajuda da aliança.",
    "calculators.cards.gear.title": "Equipamento",
    "calculators.cards.gear.description": "Planeje progressão de equipamento e materiais necessários.",
    "calculators.cards.heroExp.title": "EXP de herói",
    "calculators.cards.heroExp.description": "Estime a experiência necessária para progressão de heróis.",
    "calculators.cards.heroShards.title": "Fragmentos de herói",
    "calculators.cards.heroShards.description": "Acompanhe fragmentos necessários para progressão de heróis.",
    "calculators.cards.skillMedals.title": "Medalhas de habilidade",
    "calculators.cards.skillMedals.description": "Planeje uso de medalhas e requisitos de upgrade.",
    "calculators.cards.weaponShards.title": "Fragmentos de arma",
    "calculators.cards.weaponShards.description": "Estime os fragmentos necessários para progressão de armas.",
    ...
    "leaderControls.reachability.issueBadge": "Problemas",
    "leaderControls.reachability.allGoodBadge": "Tudo certo",
    "leaderControls.reachability.badgeOptedOut": "Desativado",
    "leaderControls.reachability.badgeNoToken": "Sem token",
    ...
    "leaderControls.joinRequests.pendingCount": "{count} pendentes",
    "leaderControls.passwordReset.eyebrow": "Controles de líder",
    "leaderControls.passwordReset.title": "Redefinir senha do membro",
    "leaderControls.passwordReset.description": "Toque para expandir e gerar uma senha temporária para um membro sem acesso.",
    "leaderControls.passwordReset.searchPlaceholder": "Buscar membros...",
    "leaderControls.passwordReset.button": "Redefinir senha",
    "leaderControls.passwordReset.confirmTitle": "Redefinir a senha de {name}?",
    "leaderControls.passwordReset.confirmDescription": "Essa pessoa solicitou uma nova senha temporária. Isso vai gerar uma para você compartilhar.",
    "leaderControls.addMember.eyebrow": "Gerenciamento do elenco",
    "leaderControls.addMember.title": "Adicionar membro",
    "leaderControls.addMember.description": "Toque para expandir e adicionar um novo membro à sua aliança.",
    "leaderControls.addMember.namePlaceholder": "Nome do membro",
    "leaderControls.addMember.powerHint": "Digite o poder em milhões (ex.: 12.700.000 = 12,7)",
    "leaderControls.addMember.powerPlaceholder": "Poder (M)",
    "leaderControls.addMember.button": "Adicionar membro",
    "leaderControls.allianceCode.eyebrow": "Gerenciamento da aliança",
    "leaderControls.allianceCode.title": "Código da aliança",
    "leaderControls.allianceCode.description": "Toque para expandir e atualizar o código de entrada da sua aliança.",
    "leaderControls.allianceCode.placeholder": "Novo código da aliança",
    "leaderControls.allianceCode.button": "Atualizar código",
