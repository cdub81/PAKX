...
// Cell width is computed dynamically in CalendarScreen using useWindowDimensions
// so it updates on rotation. This constant is exported for that calculation.
export const CALENDAR_GRID_GAP = 6;
export const CALENDAR_GRID_OUTER_PADDING = 64; // screen (16*2) + card (16*2)
...
const styles = StyleSheet.create({
  ...
  voteBannerTitle: { flex: 1, fontSize: 16, fontWeight: "700", color: DESIGN_TOKENS.colors.text },
  ...
  inputLabel: { fontSize: 11, fontWeight: "700", color: DESIGN_TOKENS.colors.textMuted, textTransform: "uppercase", letterSpacing: 0.8, marginBottom: 4 },
  ...
  bottomTabBar: { flexDirection: "row", alignItems: "stretch", justifyContent: "space-between", gap: 8, backgroundColor: DESIGN_TOKENS.colors.bgElevated, borderRadius: DESIGN_TOKENS.radius.xl, borderWidth: 1, borderColor: DESIGN_TOKENS.colors.border, paddingHorizontal: 8, paddingTop: 2, paddingBottom: Platform.OS === "ios" ? 8 : 6, shadowColor: "#000", shadowOpacity: 0.24, shadowRadius: 16, shadowOffset: { width: 0, height: -4 }, elevation: 10 },
  bottomTabButton: { flex: 1, alignItems: "center", justifyContent: "center", gap: 3, minHeight: 46, borderRadius: DESIGN_TOKENS.radius.lg, paddingHorizontal: 2, paddingVertical: 4, backgroundColor: "transparent" },
  ...
  bottomTabLabel: { color: DESIGN_TOKENS.colors.textMuted, fontWeight: "700", fontSize: 10, textAlign: "center" },
  ...
  memberStatGrid: { flexDirection: "row", gap: 10, flexWrap: "wrap" },
  memberStatCard: { flex: 1, minWidth: 0, backgroundColor: DESIGN_TOKENS.colors.surfaceSoft, borderRadius: 14, padding: 12, borderWidth: 1, borderColor: DESIGN_TOKENS.colors.borderStrong, gap: 6 },
  ...
  memberStatValue: { fontSize: 18, fontWeight: "800", color: DESIGN_TOKENS.colors.text, flexShrink: 1 },
  ...
  calendarDayCell: { width: 40, minHeight: 88, backgroundColor: DESIGN_TOKENS.colors.surfaceSoft, borderRadius: 16, borderWidth: 1, borderColor: DESIGN_TOKENS.colors.border, paddingHorizontal: 6, paddingVertical: 8, alignItems: "center", justifyContent: "space-between" },
