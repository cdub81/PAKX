  ...
  if (selection) {
    return <View style={styles.section}>
      <AppCard style={styles.settingsSectionCard} styles={styles}>
        <SectionHeader eyebrow="More" title={selection === "members" ? "Members" : selection === "settings" ? "Settings" : "Feedback"} detail="Use More for secondary destinations without adding extra top-level tabs." styles={styles} />
