...
function MyInfoView({ currentUser, desertStormAssignment, votes, todayCalendarEntries, currentZombieSiegeEvent, currentZombieSiegeAssignment, onChangeField, t }) {
  ...
  const resultLabels = { pending: t("resultPending"), win: t("resultWin"), loss: t("resultLoss") };
...
function ZombieSiegeView({ events, selectedEvent, selectedEventId, onSelectEvent, currentUser, currentUserIsLeader, newTitle, newStartAt, newEndAt, newVoteClosesAt, newThreshold, onChangeNewTitle, onChangeNewStartAt, onChangeNewEndAt, onChangeNewVoteClosesAt, onChangeNewThreshold, onCreateEvent, onSubmitAvailability, onRunPlan, onPublishPlan, onDiscardDraft, onSaveWaveOneReview }) {
  ...
  }), [noResponsePlayers, selectedEvent, reviewDrafts]);
